...
export default function VideoMeetComponent() {
  ...
  // ✅ Wrapped getPermissions in useCallback to satisfy dependency rule
  ...
  // ✅ Added getPermissions dependency
  useEffect(() => {
    getPermissions();
  }, [getPermissions]);
  ...
  // ✅ Added getUserMediaSuccess as dependency
  const getUserMedia = useCallback(() => {
    if ((video && videoAvailable) || (audio && audioAvailable)) {
      navigator.mediaDevices
        .getUserMedia({ video: video, audio: audio })
  ...
  // ✅ Added getDisplayMediaSuccess as dependency
  const getDisplayMedia = useCallback(() => {
    if (screen) {
      if (navigator.mediaDevices.getDisplayMedia) {
        navigator.mediaDevices
